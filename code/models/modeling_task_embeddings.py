...
from transformers import add_start_docstrings, BertConfig, PreTrainedModel
...
class BertTaskEmbeddingConfig(BertConfig):
    def __init__(self, num_labels=1, finetuning_task='asa', num_softmax_classifiers=1, retain_gradients=True, do_pooling=True, **kwargs):
        super().__init__(**kwargs)
        self.finetuning_task = finetuning_task
        self.num_softmax_classifiers = num_softmax_classifiers
